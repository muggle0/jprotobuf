...
public class RequrieRepeatedTypeTest {
    ...
    public void testDecodeListFields2() throws IOException {
        RequrieRepeatedType.InterClassName icn = RequrieRepeatedType.InterClassName.newBuilder().addList("abc").build();
    ...
    public void testEncodeListFields2() throws IOException {
        ...
        RequrieRepeatedType.InterClassName parseFrom = RequrieRepeatedType.InterClassName.parseFrom(bb);
