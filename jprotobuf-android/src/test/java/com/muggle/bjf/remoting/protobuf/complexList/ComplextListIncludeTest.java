 ...
 *
 */
package com.muggle.bjf.remoting.protobuf.complexList;
...
public class ComplextListIncludeTest {
    ...
    public void testEncodeDecode() {
        ...
        // protobuf -> jprotobuf
        AddressBookProtos.Person p = AddressBookProtos.Person.newBuilder().setName("xiemalin").setId(100).build();

        AddressBookProtos.AddressBook book = AddressBookProtos.AddressBook.newBuilder().addPerson(p).addPerson(p).addTypeDef(AddressBookProtos.TypeDef.DECIMAL)
                .addTypeDef(AddressBookProtos.TypeDef.URL).build();
...
//        person.email = "xiemalin@baidu.com";
        ...
        try {
            AddressBookProtos.AddressBook parseFrom = AddressBookProtos.AddressBook.parseFrom(bb);
