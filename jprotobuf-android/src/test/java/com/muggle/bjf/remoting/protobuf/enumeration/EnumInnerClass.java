...
public final class EnumInnerClass {
  ...
  public interface EnumClassInternalOrBuilder
     ...
     * <code>required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;</code>
     */
    EnumInnerClass.EnumClassInternal.EnumAttr getStatus();
  }
  /**
  ...
  public static final class EnumClassInternal extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              EnumInnerClass.EnumClassInternal.EnumAttr value = EnumInnerClass.EnumClassInternal.EnumAttr.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return EnumInnerClass.internal_static_proto_smartidea_EnumClassInternal_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return EnumInnerClass.internal_static_proto_smartidea_EnumClassInternal_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EnumInnerClass.EnumClassInternal.class, EnumInnerClass.EnumClassInternal.Builder.class);
    }
    ...
    public enum EnumAttr
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return EnumInnerClass.EnumClassInternal.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private EnumInnerClass.EnumClassInternal.EnumAttr status_;
    /**
     * <code>required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;</code>
     */
     ...
     * <code>required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;</code>
     */
    public EnumInnerClass.EnumClassInternal.EnumAttr getStatus() {
      return status_;
    }

    private void initFields() {
      status_ = EnumInnerClass.EnumClassInternal.EnumAttr.STRING;
    }
    ...
    public static EnumInnerClass.EnumClassInternal parseFrom(
    ...
    public static EnumInnerClass.EnumClassInternal parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EnumInnerClass.EnumClassInternal parseFrom(
    ...
    public static EnumInnerClass.EnumClassInternal parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EnumInnerClass.EnumClassInternal parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static EnumInnerClass.EnumClassInternal parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(EnumInnerClass.EnumClassInternal prototype) {
    ...
    public static final class Builder extends
       ...
       implements EnumInnerClass.EnumClassInternalOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EnumInnerClass.internal_static_proto_smartidea_EnumClassInternal_descriptor;
      }
      ...
      public EnumInnerClass.EnumClassInternal getDefaultInstanceForType() {
        return EnumInnerClass.EnumClassInternal.getDefaultInstance();
      }

      public EnumInnerClass.EnumClassInternal build() {
        EnumInnerClass.EnumClassInternal result = buildPartial();
      ...
      public EnumInnerClass.EnumClassInternal buildPartial() {
        EnumInnerClass.EnumClassInternal result = new EnumInnerClass.EnumClassInternal(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EnumInnerClass.EnumClassInternal) {
          return mergeFrom((EnumInnerClass.EnumClassInternal)other);
        } else {
      ...
      public Builder mergeFrom(EnumInnerClass.EnumClassInternal other) {
        if (other == EnumInnerClass.EnumClassInternal.getDefaultInstance()) return this;
        if (other.hasStatus()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EnumInnerClass.EnumClassInternal parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EnumInnerClass.EnumClassInternal) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      // required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;
      private EnumInnerClass.EnumClassInternal.EnumAttr status_ = EnumInnerClass.EnumClassInternal.EnumAttr.STRING;
      /**
       * <code>required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;</code>
       */
      public boolean hasStatus() {
       ...
       * <code>required .proto.smartidea.EnumClassInternal.EnumAttr status = 1;</code>
       */
      public Builder setStatus(EnumInnerClass.EnumClassInternal.EnumAttr value) {
        if (value == null) {
