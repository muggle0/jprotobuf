...
public final class EnumClass {
  ...
  public enum EnumAttr
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return EnumClass.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public static final class EnumClassInternal extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              EnumClass.EnumAttr value = EnumClass.EnumAttr.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return EnumClass.internal_static_proto_smartidea_EnumClassInternal_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return EnumClass.internal_static_proto_smartidea_EnumClassInternal_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              EnumClass.EnumClassInternal.class, EnumClass.EnumClassInternal.Builder.class);
    }
    ...
    private EnumClass.EnumAttr status_;
    /**
     * <code>required .proto.smartidea.EnumAttr status = 1;</code>
     */
     ...
     * <code>required .proto.smartidea.EnumAttr status = 1;</code>
     */
    public EnumClass.EnumAttr getStatus() {
      return status_;
    }

    private void initFields() {
      status_ = EnumClass.EnumAttr.STRING;
    }
    ...
    public static EnumClass.EnumClassInternal parseFrom(
    ...
    public static EnumClass.EnumClassInternal parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static EnumClass.EnumClassInternal parseFrom(
    ...
    public static EnumClass.EnumClassInternal parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static EnumClass.EnumClassInternal parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static EnumClass.EnumClassInternal parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(EnumClass.EnumClassInternal prototype) {
    ...
    public static final class Builder extends
       ...
       implements EnumClass.EnumClassInternalOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return EnumClass.internal_static_proto_smartidea_EnumClassInternal_descriptor;
      }
      ...
      public EnumClass.EnumClassInternal getDefaultInstanceForType() {
        return EnumClass.EnumClassInternal.getDefaultInstance();
      }

      public EnumClass.EnumClassInternal build() {
        EnumClass.EnumClassInternal result = buildPartial();
      ...
      public EnumClass.EnumClassInternal buildPartial() {
        EnumClass.EnumClassInternal result = new EnumClass.EnumClassInternal(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EnumClass.EnumClassInternal) {
          return mergeFrom((EnumClass.EnumClassInternal)other);
        } else {
      ...
      public Builder mergeFrom(EnumClass.EnumClassInternal other) {
        if (other == EnumClass.EnumClassInternal.getDefaultInstance()) return this;
        if (other.hasStatus()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        EnumClass.EnumClassInternal parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (EnumClass.EnumClassInternal) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      // required .proto.smartidea.EnumAttr status = 1;
      private EnumClass.EnumAttr status_ = EnumClass.EnumAttr.STRING;
      /**
       * <code>required .proto.smartidea.EnumAttr status = 1;</code>
       */
      public boolean hasStatus() {
       ...
       * <code>required .proto.smartidea.EnumAttr status = 1;</code>
       */
      public Builder setStatus(EnumClass.EnumAttr value) {
        if (value == null) {
