 ...
 */
package com.muggle.bjf.remoting.protobuf.simpletypes;
...
import com.muggle.bjf.remoting.protobuf.ReflectiveCodec;
...
public class AllTypesTest {
	...
	public void  testRequiredMutliTypeEncode() throws IOException {
		...
		AllTypes.InterClassName icn = AllTypes.InterClassName.parseFrom(bb);
	...
	public void  testRequiredMutliTypeDecode() throws IOException {
		AllTypes.InterClassName icn = AllTypes.InterClassName.newBuilder()
		    .setBoolF(true)
		    ...
		    .setUint32F(10)
		    .setUint64F(11L)
		    .setEnumT(AllTypes.InterClassName.TypeDef.ID)
		    .build();
